...
if (pubg.crate === "equinox") {
  getcss.push(PUBGITEMS[i]);
}
}
$(getcss).each(function displayResults (i, pubg){
var exportcss = ('.'+pubg.item+' {background-image: url(../img/clothes/'+pubg.item+'.png);}')
...
var crateitems = ('<div class="listcardcrate '+pubg.item+'"></div>')
...
var pubg = PUBGITEMS[i];
if (pubg.type === "key") {
  keyitems.push(PUBGITEMS[i]);
}
}
$('.keyitems').empty();
$(keyitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcardkey '+pubg.item+'"></div>')
$('.keyitems').append(crateitems);
})
...
var pubg = PUBGITEMS[i];
if (pubg.type === "crate") {
  cratelistitems.push(PUBGITEMS[i]);
}
}
$('.cratelistitems').empty();
$(cratelistitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcardcrate '+pubg.item+'"></div>')
$('.cratelistitems').append(crateitems);
})
    
var exclusivecrate = [];
for (var i = 0; i < PUBGITEMS.length; i++){
var pubg = PUBGITEMS[i];
if (pubg.type === "exclusivecrate") {
  exclusivecrate.push(PUBGITEMS[i]);
}
}
$('.exclusivecrate').empty();
$(exclusivecrate).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcardcrate '+pubg.item+'"></div>')
$('.exclusivecrate').append(crateitems);
})
    
var marketcrateitems = [];
for (var i = 0; i < PUBGITEMS.length; i++){
var pubg = PUBGITEMS[i];
if (pubg.type === "marketcrate") {
  marketcrateitems.push(PUBGITEMS[i]);
}
}
$('.marketcrateitems').empty();
$(marketcrateitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcardcrate '+pubg.item+'"></div>')
$('.marketcrateitems').append(crateitems);
})

var pioneercrateitems = [];
for (var i = 0; i < PUBGITEMS.length; i++){
var pubg = PUBGITEMS[i];
if (pubg.crate === "pioneer") {
...
var pubg = PUBGITEMS[i];
if (pubg.crate === "biker") {
  bikercrateitems.push(PUBGITEMS[i]);
}
}
$('.bikercrateitems').empty();
$(bikercrateitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcard-clothes '+pubg.item+'"></div>')
$('.bikercrateitems').append(crateitems);
})

var desperadocrateitems = [];
for (var i = 0; i < PUBGITEMS.length; i++){
var pubg = PUBGITEMS[i];
if (pubg.crate === "desperado") {
  desperadocrateitems.push(PUBGITEMS[i]);
}
}
$('.desperadocrateitems').empty();
$(desperadocrateitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcard-clothes '+pubg.item+'"></div>')
$('.desperadocrateitems').append(crateitems);
})
...
var pubg = PUBGITEMS[i];
if (pubg.crate === "fever") {
  fevercrateitems.push(PUBGITEMS[i]);
}
}
$('.fevercrateitems').empty();
$(fevercrateitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcard-clothes '+pubg.item+'"></div>')
$('.fevercrateitems').append(crateitems);
})

var militiacrateitems = [];
for (var i = 0; i < PUBGITEMS.length; i++){
var pubg = PUBGITEMS[i];
if (pubg.crate === "militia") {
  militiacrateitems.push(PUBGITEMS[i]);
}
}
$('.militiacrateitems').empty();
$(militiacrateitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcard-clothes '+pubg.item+'"></div>')
$('.militiacrateitems').append(crateitems);
})
    
var raidercrateitems = [];
for (var i = 0; i < PUBGITEMS.length; i++){
var pubg = PUBGITEMS[i];
if (pubg.crate === "raider") {
  raidercrateitems.push(PUBGITEMS[i]);
}
}

$('.raidercrateitems').empty();
$(raidercrateitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcard-clothes '+pubg.item+'"></div>')
$('.raidercrateitems').append(crateitems);
})

var triumphcrateitems = [];
for (var i = 0; i < PUBGITEMS.length; i++){
var pubg = PUBGITEMS[i];
if (pubg.crate === "triumph") {
  triumphcrateitems.push(PUBGITEMS[i]);
}
}

$('.triumphcrateitems').empty();
$(triumphcrateitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcard-clothes '+pubg.item+'"></div>')
$('.triumphcrateitems').append(crateitems);
})

var equinoxcrateitems = [];
for (var i = 0; i < PUBGITEMS.length; i++){
var pubg = PUBGITEMS[i];
if (pubg.crate === "equinox") {
  equinoxcrateitems.push(PUBGITEMS[i]);
}
}
$('.equinoxcrateitems').empty();
$(equinoxcrateitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcard-clothes '+pubg.item+'"></div>')
$('.equinoxcrateitems').append(crateitems);
})

var aviatorcrateitems = [];
for (var i = 0; i < PUBGITEMS.length; i++){
var pubg = PUBGITEMS[i];
if (pubg.crate === "aviator") {
  aviatorcrateitems.push(PUBGITEMS[i]);
}
}
$('.aviatorcrateitems').empty();
$(aviatorcrateitems).each(function displayResults (i, pubg){
var crateitems = ('<div class="listcard-clothes '+pubg.item+'"></div>')
$('.aviatorcrateitems').append(crateitems);
})
...
var clotheshead = [];
$(PUBGITEMS.skins).each(function results (i, pubg){
  if (pubg.clothetype === "head") {
    clotheshead.push(pubg);
  }
});
$('.clotheshead').empty();
...
for (var i = 0; i < PUBGITEMS.length; i++){
  var pubg = PUBGITEMS[i];
  if (pubg.clothetype === "belt") {
    clothesbelt.push(PUBGITEMS[i]);
  }
}
$('.clothesbelt').empty();
sortOn(clothesbelt, "item");
$(clothesbelt).each(function displayResults (i, pubg){
var clotheitems = ('<div class="listcard-clothes '+pubg.item+'"></div>')
$('.clothesbelt').append(clotheitems);
});
...
/* Using GASCAN as example
index.html line 210 - <div class="renderpage gascan"></div>
menu-consumables.html line 20 - link #gascan 
...
$(".renderpage." + pubg.item).html
('<div class="navbar-inner cached" data-page="'+ pubg.item +'">'+
'<div class="center">'+ pubg.type +'</div>'+
'<div class="right"><a href="#" class="open-panel link icon-only"><i class="icon icon-bars"></i></a></div>'+
'</div>'+
'<div class="page cached" data-page="'+ pubg.item +'">'+
'<div class="navbar">'+
'<div class="navbar-inner">'+
  '<div class="left"><a href="#" class="back link icon-only"><i class="icon icon-back"></i></a></div>'+
  '<div class="center">'+
    '<span class="pagetitle" data-i18n="Melee">Melee</span>'+
  '</div>'+
  '<div class="right"><a href="#" class="open-panel link icon-only"><i class="icon icon-bars"></i></a></div>'+
'</div>'+
'</div>'+
...
var marketName = pubg.name.toString().replace(/\s/g, '');
...
'</a>'+
'<a target="_blank" href="https://steamcommunity.com/market/listings/578080/'+encodeURI(pubg.name.replace(/\//g, '-'))+'" class="steamlink steambox external">'+
'<p class="pricebox">'+
...
('<div class="list">'+
'<a href="#clothes-'+ pubg.item+'" class="item-list">' +
...
'<div class="navbar-inner cached" data-page="clothes-'+ pubg.item+'">'+
'<div class="center">'+ pubg.name +'</div>'+
'<div class="right"><a href="#" class="open-panel link icon-only"><i class="icon icon-bars"></i></a></div>'+
'</div>'+
'<div class="page cached" data-page="clothes-'+ pubg.item+'">'+
'<div class="navbar">'+
'<div class="navbar-inner">'+
'<div class="left"><a href="index.html" class="back link icon-only"><i class="icon icon-back"></i></a></div>'+
'<div class="center">'+
'<span class="pagetitle" data-i18n="clothes-'+ pubg.item+'">'+ pubg.name +'</span>'+
'</div>'+
'<div class="right"><a href="#" class="open-panel link icon-only"><i class="icon icon-bars"></i></a></div>'+
'</div>'+
'</div>'+
...
'</div>'+
rarityinfo+
'<a target="_blank" href="https://steamcommunity.com/market/listings/578080/'+encodeURI(pubg.name)+'" class="steamlink item-list external">'+
'<p class="pricebox">'+
'<span class="pricesymbol"></span>'+
'<span class="priceval" data-item='+ marketName +'></span>'+
'</p>' +
...
'<div class="list">'+
'<a href="crate-'+pubg.crate+'.html" class="item-list">'+
'<i class="'+pubg.crate+'crate"></i>'+
...
'<span data-i18n="set-text">You can receive this set randomly when opening a</span>'+
'<span data-i18n="'+pubg.crate+'crate">'+pubg.cratename+'.</span>'+
'</p>'+
'<p class="text">'+
'<span data-i18n="Thisset">This set </span>'+
'<span class="redtxt" data-i18n="canbeobtainedingame">can be obtained in-game </span>'+
...
'<span data-i18n="toopenthiscrate">to open this set.</span>'+
'</p>'+
'<p class="text">'+
'<span data-i18n="Byopeningthissetyouwill">By opening this set you will </span>'+
'<span class="greentxt" data-i18n="receiveall">receive all </span>'+
...
'<div class="titleblock" data-i18n="FoundIn">Found In:</div>'+
'<div class="listcardcrate '+pubg.crate+'"></div>'
);
...
('<a target="_blank" href="https://steamcommunity.com/market/listings/578080/'+encodeURI(pubg.name.toUpperCase())+'" class="item-list external">'+
'<i class="steamicon"></i>'+
'<div class="item-text">'+
'<p class="pricebox">'+
'<span class="pricesymbol"></span>'+
...
var attdesc2 = "";
var attdesc3 = "";
if (pubg.attdesc2 != undefined) {
  attdesc2 = '<p class="bonusdesc" data-i18n="'+pubg.attdesc2[0]+'">'+pubg.attdesc2[1]+'</p>';
} else {attdesc2 = "";}
if (pubg.attdesc3 != undefined) {
  attdesc3 = '<p class="bonusdesc" data-i18n="'+pubg.attdesc3[0]+'">'+pubg.attdesc3[1]+'</p>';
} else {attdesc3 = "";}

if (pubg.attdesc1 != undefined) {
attdesc += '<div class="attdesc">'+
'<p class="bonusdesc" data-i18n="'+pubg.attdesc1[0]+'">'+pubg.attdesc1[1]+'</p>'+
attdesc2+
attdesc3+
'</div>';
} else {attdesc = '<span class="description" data-i18n="'+pubg.item+'-desc">'+pubg.desc+'</span>';}
...
var skins = "";
for (var s in PUBGITEMS[i].skins) { 
skins += '<div class="listcard-skins '+ PUBGITEMS[i].skins[s]+'-'+ pubg['item'] +'"></div>';
}
...
var opcrates = "";
for (var k in PUBGITEMS[i].opcrates) {
  opcrates += '<div class="listcardcrate '+ PUBGITEMS[i].opcrates[k]+'"></div>';
}
$(".cardkey." + pubg['item']).html
('<div class="content-block blackbb1px">'+
'<div class="item-image">'+
'<i class="'+ pubg.item +'"></i>'+
'</div>'+
'<p class="text" data-i18n="keytext-price">'+
  'This key can be purchased in-game for $ 2.50.'+
'</p>'+
'<p class="text" data-i18n="keytext-market">'+
  'This key is marketable/tradable (After 7 days).'+
'</p>'+
'</div>'+
'<div class="steampage '+ pubg.item +'"></div>'+
...
var skins = "";
for (var s in PUBGITEMS[i].skins) { 
skins += '<div class="listcard-skins '+ PUBGITEMS[i].skins[s]+'-'+ pubgitems['item'] +'"></div>';
}
var carepackage = "";
...
'<p class="stats" data-i18n="SoundRange">Sound Range</p>'+
'<div class="outer-bar soundrange" data-value="'+ pubgitems.soundrange +'" data-supressed="'+ pubgitems.supressed +'">'+
'<span class="value soundrange">'+ pubgitems.soundrange +'</span>'+
'<div class="bonus-bar soundrange"></div>'+
'<div class="inner-bar soundrange"></div>'+
'</div>'+
...
'<p class="stats" data-i18n="ReloadingTime">Reloading Time</p>'+
'<div class="outer-bar reload" data-value="'+ pubgitems.reload +'">'+
'<span class="value reload">'+ pubgitems.reload +'</span>'+
'<div class="bonus-bar reload"></div>'+
'<div class="inner-bar reload"></div>'+
'</div>'+

'</div>'+

'<div class="dmgdetails">'+
...
var marketName = pubgitems.name.toString().replace(/\s/g, '');

$(".listcardcrate." + pubgitems['item']).html
('<div class="list">'+
'<a href="crate-'+ pubgitems['item'] +'.html" class="item-list">' +
'<i class="'+ pubgitems['item'] +'crate"></i>' +
'<div class="item-text">'+
'<p class="name" data-i18n="'+ pubgitems['item'] +'">'+ pubgitems['name'] +'</p>' +
'<p class="infotext">'+
'<span class="info" data-i18n="Probability">Probability:</span>'+
'<span class="val">'+ pubgitems['probability'] +'%</span>'+
'</p>'+
'</div>'+
'</a>'+
'<a target="_blank" href="https://steamcommunity.com/market/listings/578080/'+encodeURI(pubgitems.name.replace(/\//g, '-'))+'" class="steamlink steambox external">'+
'<p class="pricebox">'+
'<span class="pricesymbol"></span>'+
'<span class="priceval" data-item='+ marketName +'></span>'+
'</p>' +
...
$(".listcardkey." + pubgitems['item']).html
('<div class="list">'+
'<a href="key-'+ pubgitems['item'] +'.html" class="item-list">' +
'<i class="'+ pubgitems['item'] +'"></i>' +
'<div class="item-text">'+
'<p class="name" data-i18n="'+ pubgitems['item'] +'">'+ pubgitems['name'] +'</p>' +
'</div>'+
...
for (var sk = 0; sk < PUBGITEMS.length; sk++) {
	var pubg = PUBGITEMS[sk];
	
	var itemset = "";
if (pubg.set != undefined) {
for (var j in PUBGITEMS[sk].set) {
itemset += '<div class="listcard-set '+ PUBGITEMS[sk].set[j]+'"></div>';
}
} else {itemset = "";}
...
$(".listcard-skins." + pubg.item).html
('<div class="list">'+
'<a href="#skins-'+ pubg.item+'" class="item-list">' +
'<div class="rarity '+ pubg.rarity +'"></div>'+
'<i class="'+ pubg.item +'"></i>' +
'<div class="item-text">'+
'<p class="name" data-i18n="'+ pubg.item +'">'+ pubg.name +'</p>'+
...
'</div>'+
'<div class="hiddenpage">'+
'<div class="navbar-inner cached" data-page="skins-'+ pubg.item+'">'+
'<div class="center">'+ pubg.name +'</div>'+
'<div class="right"><a href="#" class="open-panel link icon-only"><i class="icon icon-bars"></i></a></div>'+
'</div>'+
'<div class="page cached" data-page="skins-'+ pubg.item+'">'+
'<div class="navbar">'+
'<div class="navbar-inner">'+
'<div class="left"><a href="index.html" class="back link icon-only"><i class="icon icon-back"></i></a></div>'+
'<div class="center">'+
'<span class="pagetitle" data-i18n="skins-'+ pubg.item+'">'+ pubg.name +'</span>'+
'</div>'+
'<div class="right"><a href="#" class="open-panel link icon-only"><i class="icon icon-bars"></i></a></div>'+
'</div>'+
'</div>'+
...
'<div class="list">'+
'<a href="wpns-'+pubg.weapon+'.html" class="item-list">'+
'<i class="'+pubg.weapon+'"></i>'+
'<p class="name" data-i18n="'+pubg.weapon+'">'+pubg.weapon+'</p>'+
'</a>'+
'</div>'+
...
('<div class="item-list att '+ attachitems.unique +'" data-bonus="'+ attachitems.bonus +'" data-value="'+ attachitems.value +'" data-capacity="'+ attachitems.capacity +'" data-sound="'+ attachitems.sound +'">' +
'<i class="'+ attachitems.icon +'"></i>' +
...
$('.att').click(function(){
  ...
  var silenced = $(this).data("sound");
  var silencer = $(this).parents('.slots').find('.slot.muzzle').attr('class').split(' ')[2];
  ...
  var sound = $(this).parents('.single-item').find('.outer-bar.soundrange').attr('data-value');
  var supressed = $(this).parents('.single-item').find('.outer-bar.soundrange').attr('data-supressed');
  ...
  if (silenced == "silenced" && silencer !== "supressorsniper") {
    console.log("True");
    $(this).parents('.single-item').find('.value.soundrange').html(supressed);
    $(this).parents('.single-item').find('.inner-bar.soundrange').width('0%');
    $(this).parents('.single-item').find('.bonus-bar.soundrange').width((supressed/10)+'%');
  } else if (silenced == "undefined" && silencer !== "supressorsniper") {
    console.log("silenced= "+silenced+ "silencer= "+silencer);
    $(this).parents('.single-item').find('.value.soundrange').html(sound);
    $(this).parents('.single-item').find('.inner-bar.soundrange').width((sound/10)+'%');
    $(this).parents('.single-item').find('.bonus-bar.soundrange').width('0%');
  } else {
    console.log("WRONG = silenced= "+silenced+ "silencer= "+silencer);
    $(this).parents('.single-item').find('.value.soundrange').html(sound);
    $(this).parents('.single-item').find('.inner-bar.soundrange').width((sound/10)+'%');
    $(this).parents('.single-item').find('.bonus-bar.soundrange').width('0%');
  }
...
$(".inner-bar").each(function(e){
  var highvalue = $(this).attr('class').split(' ')[1];
  var value = $(this).parent().data('value');
  
  if (highvalue == "bulletspeed" || highvalue == "range" || highvalue == "soundrange") {
    $(this).width((value/10)+'%');
  }
  else {
    if (value > 100) {
...
var newspage = $$('#newspage').attr('data-page');
if (newspage != null) {
...
//https://pubgnews.herokuapp.com/
$.get("https://pubgnews.herokuapp.com/https://api.steampowered.com/ISteamNews/GetNewsForApp/v0002/?appid=578080&count=9999&format=json", function(data) {
//console.log(data.appnews.newsitems); <- RAW STEAM NEWS
var dataNews = data.appnews.newsitems;
var news = [];
for (var i = 0; i < dataNews.length; i++){
  var newsfeed = dataNews[i];
  if (newsfeed.feedname === "steam_community_announcements") {
    news.push(dataNews[i]);
  }
}
$('#news').empty();
$('#loadNews').removeClass('hide').fadeIn(1000);
//console.log(news);

var Default=5;
var DefaultViewMore=2;
var inc=0;

drawTable(news,Default);
...
function drawTable(news,bindRow) {

  for (var i = inc; i < news.length; i++) {
    drawRow(news[i]);
    if(news.length-1 == i)  {
      $("#loadNews").hide();
    }
...
function drawRow(newsData) {
  var contents = (newsData.contents);
  //console.log(contents);
  contents = contents.replace(/\[img\]/gi, '<img src=').replace(/\[\/img\]/gi, '>').replace(/\[h1]/gi, '<h1>').replace(/\[\/h1]/gi, '</h1>').replace(/\[b]/gi, '<b>').replace(/\[\/b]/gi, '</b>').replace(/\[i]/gi, '<em>').replace(/\[\/i]/gi, '</em>').replace(/\[u]/gi, '<u>').replace(/\[\/u]/gi, '</u>').replace(/\[list\]/gi, '<ul>').replace(/\[\/list\]\[\/list\]/gi, '</ul></li></ul>').replace(/\[\/list\]/gi, '</ul>').replace(/\[\*\](.*?)(\n|\r\n?)/gi, '<li>$1</li>').replace(/\[olist\]/gi, '<ol>').replace(/\[\/olist\]/gi, '</ol>').replace(/\[url=([^\s\]]+)\s*\]/gi, '<a href="$1">').replace(/\[\/url\]/gi, '</a>').replace(/\[\*\]/gi, '<li>').replace(/\[strike]/gi, '<span class="bb_strike">').replace(/\[\/strike]/gi, '</span>').replace(/\[spoiler]/gi, '<span class="bb_spoiler"><span>').replace(/\[\/spoiler]/gi, '</span></span>').replace(/\[code]/gi, '<span class="bb_code">').replace(/\[\/code]/gi, '</span>').replace(/\[quote]/gi, '<blockquote class="bb_blockquote">').replace(/\[\/quote]/gi, '</blockquote>');
  //console.log(contents);
  var newsdate = toDate(newsData.date);
  newsdate = newsdate.toLocaleDateString();
  var lastnews = ('<div class="newsblock">'+
                  '<div class="announceIcon"></div>'+
                  '<div class="title">'+newsData.title+'</div>'+
                  '<div class="dateauthor">'+
                  '<span class="newsdate">'+newsdate+'</span>'+
                  '<span class="author"> - '+newsData.author+'</span>'+
                  '</div>'+
                  '<div class="newscontent">'+contents+'</div>'+
                  '</div>')
  //$('#news').append(lastnews);
  $(lastnews).hide().appendTo("#news").fadeIn(1000);
}
});
}
...
function showprices() {
  ...
  var money = localStorage.getItem("language");
  
  for (var i = 0; i < steamPrices.length; i++){
      var item = steamPrices[i].item;
      var item = item.toString().replace(/\s/g, '');
      var price = steamPrices[i].price;
      ...
      $('.priceval').filter(function(){
        return $(this).data("item") == item}).html(price);
      $('.pricesymbol').filter(function(){
        return $(this).parent().find('.priceval').data("item") == item}).html(currency);
  }
  
  if ($('.priceval').html() == "") {
        $(this).parent().find('.pricesymbol').html("");
  }
}
showprices ();
  ...
  if (+newValue > +totalWeight ) {
    ...
    if ($(".inventory-items").find("."+itemAdded).length) {
      ...
      var sortedList =  $(".inventory-items").find(".itemstoadd").sort(
        function(a,b){
          var OrderA  = $(a).find('.item-list').data('order');
          var OrderB  = $(b).find('.item-list').data('order');
